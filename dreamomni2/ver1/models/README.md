...
This repository contains **DreamOmni2**, a family of multimodal autoregressive models capable of various vision and language tasks, particularly excelling in multimodal instruction-based editing and generation. These tasks support both text and image instructions and extend the scope to include both concrete and abstract concepts, greatly enhancing their practical applications.

<p align="center">
    <a href="https://huggingface.co/papers/2510.06679">
            <img alt="Paper" src="https://img.shields.io/badge/arXiv%20paper-2510.06679v1-b31b1b.svg">
    </a>
    <a href="https://pbihao.github.io/projects/DreamOmni2/index.html">
        <img alt="Project Page" src="https://img.shields.io/badge/Project-Page-blue">
    </a>
    <a href="https://github.com/dvlab-research/DreamOmni2">
        <img alt="Code" src="https://img.shields.io/badge/GitHub-Code-keygen.svg?logo=github">
    </a>
    <a href="https://huggingface.co/datasets/xiabs/DreamOmni2Bench">
        <img alt="DreamOmni2 Benchmark" src="https://img.shields.io/badge/DreamOmni2-Benchmark-green">
    </a>
    <a href="https://huggingface.co/xiabs/DreamOmni2">
        <img alt="HF Model" src="https://img.shields.io/badge/%F0%9F%A4%97-HF%20Model-yellow">
    </a>    
    <a href="https://huggingface.co/xiabs/DreamOmni2">
        <img alt="HF Demo" src="https://img.shields.io/badge/%F0%9F%A4%97-HF%20Demo-yellow">
    </a>
</p>

<p align="center">
  <img width="600" src="https://github.com/dvlab-research/DreamOmni2/raw/main/imgs/gallery.png">
</p>
...
If you find this project useful for your research, please consider citing our [paper](https://huggingface.co/papers/2510.06679).

```bibtex
@article{xia2025dreamomni2,
      title={DreamOmni2: Multimodal Instruction-based Editing and Generation},
      author={Bin Xia and Binbin Liu and Haokun Lin and Zhichao Wei and Haifeng Shi and Rui Wang and Sijie Yan and Hongsheng Li and Guanglu Song and Yanwei Fu},
      year={2025},
      eprint={2510.06679},
      archivePrefix={arXiv},
      primaryClass={cs.CV},
...
## Contact
If you have any comments or questions, please [open a new issue](https://github.com/dvlab-research/DreamOmni2/issues/new/choose) or contact [Bin Xia](zjbinxia@gmail.com).